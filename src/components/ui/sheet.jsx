...
function SheetOverlay({ className, ...props }) {
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-[3000] bg-black/60 backdrop-blur-md duration-100 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className,
      )}
      {...props}
    />
