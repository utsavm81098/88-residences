...
const HoverTooltip = ({
  ...
  return (
    ...
    >
      <Card className="!p-0 !bg-white ring-0 border border-gray-200 rounded-2xl min-w-[240px] max-w-[280px] shadow-2xl !text-gray-900">
        <CardContent className="px-4 py-4 flex flex-col gap-y-4">
          <div className="flex justify-between items-center">
            ...
            {status === "available" ? (
              <span className="text-[15px] font-bold text-gray-800 tracking-tight text-start">
