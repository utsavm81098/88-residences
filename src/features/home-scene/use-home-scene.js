...
const LANDSCAPE_NAME_RE =
  /grass|earth|ground|road|path|sand|gravel|terrain|off_road/i;
...
const CONTEXT_BUILDING_RE =
  /^(build0|off_road|bg_|context_|surround_|line019[\s_]*build)/i;
    ...
    scene.traverse((child) => {
      ...
      materials.forEach((material, index) => {
        ...
        const isAlphaMaskedUnlitFoliage =
          !isPanorama &&
          (isFoliage ||
            (material.isMeshBasicMaterial && material.alphaTest > 0)) &&
          material.map;
